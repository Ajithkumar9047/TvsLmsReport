Feature:As s scheduler I want to check the Cancellation process, so that I can initiate the auto refund
      ...
      Scenario: Should verify the cancellation process when the Cancellation completed and Refund status is Mismatch
            ...
            """
      Scenario: Should verify the booking is auto Refund without passing the Refund status with IsCancellation Completed  
            Given Post the booking without Refund status with IsCancellation Completed
            When I receive a response
            Then I expect the response as
            """
            {
...
#--------------------------------------------------------second report---------------------------------------------------------
      ...
      #       }
      #       """
      # Scenario:Should verify the cancellation process with Refund details in PreLaunchcity 
      #       Given Post of Cancellation process with Refund details in PreLaunchcity 
      #       When I receive a response
      #       Then I expect the response as
      #       """
      #       {
